		   ...
		   (
	           ...
	           (
			      ...
			      ((
				   ...
				   N == 3,
		                   format("Monstre : ~p ~p ~p ~n",[N,Xb,Yb]),
		                   Xup is Xb + 1,
		                   Xdown is Xb -1,
		                   Yup is Yb + 1,
				   Ydown is Yb - 1,
			      ...
			      ((
				   ...
				   Nt == 3,
				   format("Tresor : ~p ~p ~p ~n",[Nt,Xb,Yb]),
		                   Xtup is Xb + 1,
		                   Xtdown is Xb -1,
		                   Ytup is Yb + 1,
				   Ytdown is Yb - 1,
		                   (((maybeTresor([Xtup,Yb]);(not(sureTresor([Xtup,Yb])),not(sureNotTresor([Xtup,Yb])))), not(mur([Xtup,Yb])), retractall(maybeTresor([Xtup,Yb])), assert(sureTresor([Xtup,Yb])), tresorTrouve(Xtup,Yb,1,1), assert(sureNotTrou([Xtup,Yb])), assert(sureNotMonstre([Xtup,Yb])), assert(sureNotAscenseur([Xtup,Yb])), assert(safe([Xtup,Yb])) );!),
		                   (((maybeTresor([Xtdown,Yb]);(not(sureTresor([Xtdown,Yb])),not(sureNotTresor([Xtdown,Yb])))), not(mur([Xtdown,Yb])), retractall(maybeTresor([Xtdown,Yb])), assert(sureTresor([Xtdown,Yb])), tresorTrouve(Xtdown,Yb,1,1), assert(sureNotTrou([Xtdown,Yb])), assert(sureNotMonstre([Xtdown,Yb])), assert(sureNotAscenseur([Xtdown,Yb])), assert(safe([Xtdown,Yb])));!),
		                   (((maybeTresor([Xb,Ytup]);(not(sureTresor([Xb,Ytup])),not(sureNotTresor([Xb,Ytup])))), not(mur([Xb,Ytup])), retractall(maybeTresor([Xb,Ytup])), assert(sureTresor([Xb,Ytup])), tresorTrouve(Xb,Ytup,1,1), assert(sureNotTrou([Xb,Ytup])), assert(sureNotMonstre([Xb,Ytup])), assert(sureNotAscenseur([Xb,Ytup])), assert(safe([Xb,Ytup])));!),
		                   (((maybeTresor([Xb,Ytdown]);(not(sureTresor([Xb,Ytdown])),not(sureNotTresor([Xb,Ytdown])))), not(mur([Xb,Ytdown])), retractall(maybeTresor([Xb,Ytdown])), assert(sureTresor([Xb,Ytdown])), tresorTrouve(Xb,Ytdown,1,1), assert(sureNotTrou([Xb,Ytdown])), assert(sureNotMonstre([Xb,Ytdown])), assert(sureNotAscenseur([Xb,Ytdown])), assert(safe([Xb,Ytdown])));!)
			      );!),
			      ((
				   visite([Xb,Yb]),
		                   bruit([Xb,Yb]),
				   ...
				   Na == 3,
				   format("Ascenseur : ~p ~p ~p ~n",[Na,Xb,Yb]),
		                   Xaup is Xb + 1,
		                   Xadown is Xb -1,
		                   Yaup is Yb + 1,
				   Yadown is Yb - 1,
		                   (((maybeAscenseur([Xaup,Yb]);(not(sureAscenseur([Xaup,Yb])),not(sureNotAscenseur([Xaup,Yb])))), not(mur([Xaup,Yb])), retractall(maybeAscenseur([Xaup,Yb])), assert(sureAscenseur([Xaup,Yb])), ascenseurTrouve(Xaup,Yb,1,1), assert(sureNotTrou([Xaup,Yb])), assert(sureNotMonstre([Xaup,Yb])), assert(sureNotTresor([Xaup,Yb])), assert(safe([Xaup,Yb])));!),
		                   (((maybeAscenseur([Xadown,Yb]);(not(sureAscenseur([Xadown,Yb])),not(sureNotAscenseur([Xadown,Yb])))), not(mur([Xadown,Yb])), retractall(maybeAscenseur([Xadown,Yb])), assert(sureAscenseur([Xadown,Yb])), ascenseurTrouve(Xadown,Yb,1,1), assert(sureNotTrou([Xadown,Yb])), assert(sureNotMonstre([Xadown,Yb])), assert(sureNotTresor([Xadown,Yb])), assert(safe([Xadown,Yb])));!),
		                   (((maybeAscenseur([Xb,Yaup]);(not(sureAscenseur([Xb,Yaup])),not(sureNotAscenseur([Xb,Yaup])))), not(mur([Xb,Yaup])), retractall(maybeAscenseur([Xb,Yaup])), assert(sureAscenseur([Xb,Yaup])), ascenseurTrouve(Xb,Yaup,1,1), assert(sureNotTrou([Xb,Yaup])), assert(sureNotMonstre([Xb,Yaup])), assert(sureNotTresor([Xb,Yaup])), assert(safe([Xb,Yaup])));!),
		                   (((maybeAscenseur([Xb,Yadown]);(not(sureAscenseur([Xb,Yadown])),not(sureNotAscenseur([Xb,Yadown])))), not(mur([Xb,Yadown])), retractall(maybeAscenseur([Xb,Yadown])), assert(sureAscenseur([Xb,Yadown])), ascenseurTrouve(Xb,Yadown,1,1), assert(sureNotTrou([Xb,Yadown])), assert(sureNotMonstre([Xb,Yadown])), assert(sureNotTresor([Xb,Yadown])), assert(safe([Xb,Yadown])));!)
			      );!),
	...
	(
		 ...
		 (Xa > 4, Xb is 1, Yb is Ya + 1)
		   ...
		   (
	           ...
	           (
		         ((
			     Xb == X, Yb == Y, retractall(sureNotTresor([Xb,Yb])),  retractall(maybeTresor([Xb,Yb]))
		         );(
	...
	(
		 ...
		 (Xa > 4, Xb is 1, Yb is Ya + 1)
		   ...
		   (
	           ...
	           (
		         ((
			     Xb == X, Yb == Y, retractall(sureNotAscenseur([Xb,Yb])),  retractall(maybeAscenseur([Xb,Yb]))
		         );(
	...
	(
		 ...
		 (Xa > 4, Xb is 1, Yb is Ya + 1)
		   ...
		   (
	           ...
	           (
		         ((
			     Xb == X, Yb == Y, retractall(sureNotMonstre([Xb,Yb])),  retractall(maybeMonstre([Xb,Yb]))
		         );(
